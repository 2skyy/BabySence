...
#ifndef FLUTTER_PROJECT_SWIFT_H
#define FLUTTER_PROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_project",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15flutter_project11AppDelegate")
...
SWIFT_CLASS("_TtC15flutter_project17MainFlutterWindow")
